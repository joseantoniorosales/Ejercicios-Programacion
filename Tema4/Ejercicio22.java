  ...
  public static void main(String[] args) {
    ...
    switch(dia) {
      ...
      case "viernes":
        ...
        break;
      default:
        System.out.print("La información introducida no es correcta");
    }
    
    System.out.println("Ahora introduce tanto horas como minutos (pulse ENTER tras introducir cada dato)");
